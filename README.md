...
- Adversarial audios produced by adaptive attacks against different defenses:
    ...
    - Feature-level defense: [[FeCo (EOT)]](https://drive.google.com/uc?id=1bwz9WuDpv94tj77Zx_tJU_lwjQdwGZA7&export=download) [[FeCo (Replcate)]](https://drive.google.com/uc?id=1-ZbQhQoBeNWtoiIt4Ha16ruVtOtdHVjy&export=download)
